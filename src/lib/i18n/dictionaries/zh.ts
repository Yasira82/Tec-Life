export const zh = {
  ...
  life: {
    ...
    privacy: {
      ...
      trajectory: '节奏',
      intentTitle: '此刻',
      intentNote: '如果你允许，Life 会这样描述你在做的事。保留 30 分钟，然后自动忘记。',
      intentNone: '最近 30 分钟没有记录。',
      intentExpires: '{n} 分钟后忘记',
      kGoal: '设定目标',
      kProgress: '记录进度',
      kDone: '达成目标',
      kSkill: '添加技能',
      kLevel: '提升技能',
      kPref: '修改偏好',
      deleteTitle: '删除我的 Life 数据',
      deleteDesc: '目标、技能、偏好以及这些权限。你的付款和 TEC 账号不受影响。',
      delete: '删除',
      confirm: '再点一次确认 — 无法撤销',
      deleting: '删除中…',
      deleted: '已删除。',
