export const id = {
  ...
  life: {
    ...
    privacy: {
      ...
      activity: 'Aktivitas',
      trajectory: 'Tempo',
      intentTitle: 'Sekarang',
      intentNote: 'Yang akan Life katakan tentang aktivitasmu, kalau kamu izinkan. Disimpan 30 menit, lalu dilupakan sendiri.',
      intentNone: 'Tidak ada dalam 30 menit terakhir.',
      intentExpires: 'dilupakan dalam {n} mnt',
      kGoal: 'Menetapkan tujuan',
      kProgress: 'Mencatat progres',
      kDone: 'Mencapai tujuan',
      kSkill: 'Menambah keterampilan',
      kLevel: 'Menaikkan keterampilan',
      kPref: 'Mengubah preferensi',
      deleteTitle: 'Hapus data Life saya',
      deleteDesc: 'Tujuan, keterampilan, preferensi, dan izin ini. Pembayaran dan akun TEC kamu tidak disentuh.',
      delete: 'Hapus',
      confirm: 'Ketuk lagi untuk konfirmasi — tidak bisa dibatalkan',
      deleting: 'Menghapus…',
      deleted: 'Terhapus.',
      failed: 'Gagal menghapus. Coba lagi.',
    },
    trajectory: {
      title: 'Tempo',
      perWeek: 'π / minggu',
