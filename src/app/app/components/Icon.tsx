...
// Life's app shell gets clean line icons WITHOUT bumping tec-ui to 2.x (a coordinated
// breaking palette change). Paths mirror @yasser172/tec-ui Icon (lucide-style, 24-grid).
import type { CSSProperties } from 'react';

export type LifeIconName = 'home' | 'trophy' | 'chart' | 'settings' | 'chevron-right';

const PATHS: Record<LifeIconName, string> = {
...
export function Icon({
  ...
  name: LifeIconName; size?: number; color?: string; strokeWidth?: number; style?: CSSProperties;
}) {
  return (
    <svg
